...
from game_agent import aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2, cs_score
...
def main():
    ...
    test_agents = [
                   ...
                   Agent(CustomPlayer(score_fn=cs_score, **CUSTOM_ARGS), "CS")]
